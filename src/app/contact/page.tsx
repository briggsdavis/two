...
export const metadata: Metadata = {
  title: "Contact",
  description: "Questions, want-lists, consignments — get in touch with Two O'Clock Trading.",
...
export default function ContactPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-24">
      <p className="mb-6 text-xs tracking-[0.2em] text-ink/60 uppercase">Contact</p>
      ...
      <p className="mt-8 max-w-xl text-lg leading-relaxed text-ink/80">
        Questions about a listing, consignments, or hunting down a specific card. Write to us and
        we&apos;ll write back, usually within a day.
      </p>
      ...
      <dl className="mt-12 grid gap-8 sm:grid-cols-2">
        ...
        <div>
          <dt className="text-xs tracking-[0.2em] text-ink/60 uppercase">Hours</dt>
